  ...
  Widget build(BuildContext context) {
    return _LegalPageScaffold(
      ...
      sections: const [
        _LegalSection(
          '제1조 (목적)',
          '본 약관은 단추(이하 "서비스")가 제공하는 반려견 산책 기록, 커뮤니티, 강아지 프로필(단카) 및 모임 서비스의 이용 조건과 절차, 이용자와 서비스 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.',
        ),
        _LegalSection(
          '제2조 (용어의 정의)',
          '① "서비스"란 단추 앱을 통해 제공되는 모든 기능을 의미합니다.\n'
          '② "이용자"란 본 약관에 동의하고 서비스를 이용하는 회원을 말합니다.\n'
          '③ "단카"란 이용자가 등록한 반려견의 프로필 카드를 의미합니다.\n'
    ...
    return _LegalPageScaffold(
      ...
      sections: const [
        ...
        _LegalSection(
          ...
          '  - 위탁 목적: 데이터 저장, 사용자 인증, 파일 보관\n\n'
          '· Google Firebase Cloud Messaging (FCM)\n'
          '  - 위탁 목적: 푸시 알림 발송\n\n'
          '· Google Firebase Analytics\n'
          '  - 위탁 목적: 서비스 이용 통계 분석 및 서비스 품질 개선\n\n'
          '· Google Firebase Cloud Functions\n'
          '  - 위탁 목적: 서버리스 백엔드 로직 처리\n\n'
          '· 네이버 클라우드 플랫폼 (네이버 지도)\n'
          ...
          '· 네이버 (Naver Login SDK)\n'
          '  - 위탁 목적: 소셜 로그인 인증\n\n'
          '위탁받은 업체들은 모두 GDPR 및 관련 법령에 따른 데이터 보호 의무를 준수합니다.',
        ),
        _LegalSection(
          '6. 위치정보 처리',
        ...
        _LegalSection(
          '7. 통계 분석 및 광고 식별자',
          '· 단추는 서비스 품질 개선을 위해 Google Firebase Analytics를 사용하여 익명화된 사용 통계를 수집합니다.\n'
          '· 단추는 광고 식별자(IDFA, IDFV)를 수집하지 않으며, 이용자를 추적하지 않습니다.\n'
          '· 수집되는 통계 데이터는 앱 사용 빈도, 화면 이동 경로, 기능 사용 현황 등이며, 모두 익명으로 처리됩니다.\n'
          '· 단추는 수집된 데이터를 광고 목적으로 사용하지 않으며, 제3자에게 제공하지 않습니다.',
        ),
        _LegalSection(
          '8. 이용자의 권리',
          '이용자는 언제든지 다음의 권리를 행사할 수 있습니다.\n\n'
          '· 개인정보 조회 및 수정: 앱 내 내 정보 수정 메뉴\n'
        ...
        _LegalSection(
          '10. 개인정보 보호책임자',
          '개인정보 처리에 관한 문의 및 권리 행사는 아래로 연락해 주세요.\n\n'
          '· 서비스명: 단추\n'
          '· 책임자: 김규린\n'
          '· 이메일: danchu@danchu.app\n'
          '· 처리 기한: 접수 후 10일 이내 회신\n\n'
          '이용자는 개인정보보호법에 따른 개인정보 침해 신고를 아래 기관에 할 수 있습니다.\n\n'
        ...
        _LegalSection(
          '11. 아동의 개인정보 보호',
          '· 단추는 만 14세 미만 아동의 회원가입을 받지 않습니다.\n'
          '· 만 14세 미만 아동이 회원가입한 사실이 확인될 경우, 단추는 즉시 해당 계정을 삭제하고 수집된 개인정보를 파기합니다.\n'
          '· 만 14세 이상의 미성년자도 본 서비스를 이용할 수 있으며, 보호자의 동의 하에 이용할 것을 권장합니다.',
        ),
        _LegalSection(
          '12. 개인정보처리방침 변경',
