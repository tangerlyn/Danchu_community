...
class MeetupChatPage extends StatelessWidget {
  final String postId;
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(
      MeetupChatController(postId: postId, postTitle: postTitle),
      tag: postId,
    );
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _showChatMenu(context, controller),
          ),
        ],
      ),
      body: Column(
  ...
  Widget _buildMessageBubble({
    ...
    required MeetupChatController controller,
  }) {
    ...
    Widget bubbleContent = Container(
      ...
      decoration: BoxDecoration(
        color: isMine ? AppColors.deepBrown : AppColors.white,
      ...
      child: Column(
        ...
        children: [
          if (msg.imageUrl != null)
            GestureDetector(
              onTap: () => Get.to(() => ImageFullScreenPage(imageUrl: msg.imageUrl!)),
              child: Padding(
          ...
          if (msg.message.isNotEmpty)
            Text(
              ...
              style: TextStyle(
                fontSize: 14,
                color: isMine ? AppColors.white : AppColors.deepBrown,
                height: 1.4,
              ),
            ),
        ],
      ...
      child: Row(
        ...
        children: [
          ...
          if (isMine) ...[
            ...
            if (showProfileAndName)
              GestureDetector(
                onTap: () => Get.to(() => ChatUserProfilePage(uid: controller.currentUid!)),
                child: Obx(() {
                  final imageUrl = controller.userProfileImages[controller.currentUid];
                  return CircleAvatar(
                    radius: 16,
                    backgroundColor: AppColors.sand,
                    backgroundImage: imageUrl != null && imageUrl.isNotEmpty
  ...
  Widget _buildInputBar(BuildContext context, MeetupChatController controller) {
    return Padding(
      padding: EdgeInsets.only(
            ...
            children: [
              SizedBox(
                ...
                child: IconButton(
                  ...
                  onPressed: () => _showImageSourceActionSheet(context, controller),
  ...
  void _showChatMenu(BuildContext context, MeetupChatController controller) {
  ...
  void _showRenameDialog(BuildContext context, MeetupChatController controller) {
  ...
  void _showLeaveConfirmDialog(BuildContext context, MeetupChatController controller) {
  ...
  void _showImageSourceActionSheet(BuildContext context, MeetupChatController controller) {
    showModalBottomSheet(
      context: context,
